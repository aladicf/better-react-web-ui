...
This compatibility wrapper exposes the `adapt` skill for the `.opencode/skills` layout while keeping `skills/adapt/SKILL.md` as the canonical source of truth.

Follow the canonical instructions in [../../../skills/adapt/SKILL.md](../../../skills/adapt/SKILL.md).
