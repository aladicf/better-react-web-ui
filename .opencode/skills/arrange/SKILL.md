...
This compatibility wrapper exposes the `arrange` skill for the `.opencode/skills` layout while keeping `skills/arrange/SKILL.md` as the canonical source of truth.

Follow the canonical instructions in [../../../skills/arrange/SKILL.md](../../../skills/arrange/SKILL.md).
