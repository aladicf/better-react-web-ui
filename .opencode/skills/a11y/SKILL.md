...
metadata:
  argument-hint: "[component, page, or WCAG issue]"
---

This compatibility wrapper exposes the `a11y` skill for the `.opencode/skills` layout while keeping `skills/a11y/SKILL.md` as the canonical source of truth.

Follow the canonical instructions in [../../../skills/a11y/SKILL.md](../../../skills/a11y/SKILL.md).
