...
This compatibility wrapper exposes the `localize` skill for the `.opencode/skills` layout while keeping `skills/localize/SKILL.md` as the canonical source of truth.

Follow the canonical instructions in [../../../skills/localize/SKILL.md](../../../skills/localize/SKILL.md).
