...
This compatibility wrapper exposes the `security-ux` skill for the `.opencode/skills` layout while keeping `skills/security-ux/SKILL.md` as the canonical source of truth.

Follow the canonical instructions in [../../../skills/security-ux/SKILL.md](../../../skills/security-ux/SKILL.md).
