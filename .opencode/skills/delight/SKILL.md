...
This compatibility wrapper exposes the `delight` skill for the `.opencode/skills` layout while keeping `skills/delight/SKILL.md` as the canonical source of truth.

Follow the canonical instructions in [../../../skills/delight/SKILL.md](../../../skills/delight/SKILL.md).
