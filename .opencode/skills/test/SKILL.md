...
This compatibility wrapper exposes the `test` skill for the `.opencode/skills` layout while keeping `skills/test/SKILL.md` as the canonical source of truth.

Follow the canonical instructions in [../../../skills/test/SKILL.md](../../../skills/test/SKILL.md).
