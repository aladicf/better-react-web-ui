...
This compatibility wrapper exposes the `colorize` skill for the `.opencode/skills` layout while keeping `skills/colorize/SKILL.md` as the canonical source of truth.

Follow the canonical instructions in [../../../skills/colorize/SKILL.md](../../../skills/colorize/SKILL.md).
