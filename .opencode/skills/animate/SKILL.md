...
This compatibility wrapper exposes the `animate` skill for the `.opencode/skills` layout while keeping `skills/animate/SKILL.md` as the canonical source of truth.

Follow the canonical instructions in [../../../skills/animate/SKILL.md](../../../skills/animate/SKILL.md).
