...
metadata:
  argument-hint: "[copy surface or flow]"
---

This compatibility wrapper exposes the `clarify` skill for the `.opencode/skills` layout while keeping `skills/clarify/SKILL.md` as the canonical source of truth.

Follow the canonical instructions in [../../../skills/clarify/SKILL.md](../../../skills/clarify/SKILL.md).
