...
This compatibility wrapper exposes the `imagery` skill for the `.opencode/skills` layout while keeping `skills/imagery/SKILL.md` as the canonical source of truth.

Follow the canonical instructions in [../../../skills/imagery/SKILL.md](../../../skills/imagery/SKILL.md).
