...
This compatibility wrapper exposes the `add-ui` skill for the `.opencode/skills` layout while keeping `skills/add-ui/SKILL.md` as the canonical source of truth.

Follow the canonical instructions in [../../../skills/add-ui/SKILL.md](../../../skills/add-ui/SKILL.md).
