...
This compatibility wrapper exposes the `frontend-design` skill for the `.opencode/skills` layout while keeping `skills/frontend-design/SKILL.md` as the canonical source of truth.

Follow the canonical instructions in [../../../skills/frontend-design/SKILL.md](../../../skills/frontend-design/SKILL.md).
