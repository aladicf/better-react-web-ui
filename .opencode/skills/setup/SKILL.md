...
This compatibility wrapper exposes the `setup` skill for the `.opencode/skills` layout while keeping `skills/setup/SKILL.md` as the canonical source of truth.

Follow the canonical instructions in [../../../skills/setup/SKILL.md](../../../skills/setup/SKILL.md).
