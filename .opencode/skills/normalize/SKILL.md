...
This compatibility wrapper exposes the `normalize` skill for the `.opencode/skills` layout while keeping `skills/normalize/SKILL.md` as the canonical source of truth.

Follow the canonical instructions in [../../../skills/normalize/SKILL.md](../../../skills/normalize/SKILL.md).
