...
This compatibility wrapper exposes the `depth` skill for the `.opencode/skills` layout while keeping `skills/depth/SKILL.md` as the canonical source of truth.

Follow the canonical instructions in [../../../skills/depth/SKILL.md](../../../skills/depth/SKILL.md).
