...
metadata:
  argument-hint: "[component set or repeated pattern]"
---

This compatibility wrapper exposes the `extract` skill for the `.opencode/skills` layout while keeping `skills/extract/SKILL.md` as the canonical source of truth.

Follow the canonical instructions in [../../../skills/extract/SKILL.md](../../../skills/extract/SKILL.md).
