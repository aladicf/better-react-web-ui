...
This compatibility wrapper exposes the `data-viz` skill for the `.opencode/skills` layout while keeping `skills/data-viz/SKILL.md` as the canonical source of truth.

Follow the canonical instructions in [../../../skills/data-viz/SKILL.md](../../../skills/data-viz/SKILL.md).
