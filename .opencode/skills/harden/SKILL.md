...
metadata:
  argument-hint: "[screen, flow, or edge case]"
---

This compatibility wrapper exposes the `harden` skill for the `.opencode/skills` layout while keeping `skills/harden/SKILL.md` as the canonical source of truth.

Follow the canonical instructions in [../../../skills/harden/SKILL.md](../../../skills/harden/SKILL.md).
