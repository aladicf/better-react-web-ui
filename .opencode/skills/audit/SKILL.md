...
This compatibility wrapper exposes the `audit` skill for the `.opencode/skills` layout while keeping `skills/audit/SKILL.md` as the canonical source of truth.

Follow the canonical instructions in [../../../skills/audit/SKILL.md](../../../skills/audit/SKILL.md).
