...
This compatibility wrapper exposes the `hierarchy` skill for the `.opencode/skills` layout while keeping `skills/hierarchy/SKILL.md` as the canonical source of truth.

Follow the canonical instructions in [../../../skills/hierarchy/SKILL.md](../../../skills/hierarchy/SKILL.md).
