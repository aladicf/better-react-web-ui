...
This compatibility wrapper exposes the `polish` skill for the `.opencode/skills` layout while keeping `skills/polish/SKILL.md` as the canonical source of truth.

Follow the canonical instructions in [../../../skills/polish/SKILL.md](../../../skills/polish/SKILL.md).
