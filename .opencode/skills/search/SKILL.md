...
This compatibility wrapper exposes the `search` skill for the `.opencode/skills` layout while keeping `skills/search/SKILL.md` as the canonical source of truth.

Follow the canonical instructions in [../../../skills/search/SKILL.md](../../../skills/search/SKILL.md).
