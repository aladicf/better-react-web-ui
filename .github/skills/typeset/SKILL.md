...
This compatibility wrapper exposes the `typeset` skill for the `.github/skills` layout while keeping `skills/typeset/SKILL.md` as the canonical source of truth.
