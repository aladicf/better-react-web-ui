...
This compatibility wrapper exposes the `harden` skill for the `.github/skills` layout while keeping `skills/harden/SKILL.md` as the canonical source of truth.
