...
This compatibility wrapper exposes the `onboard` skill for the `.github/skills` layout while keeping `skills/onboard/SKILL.md` as the canonical source of truth.
