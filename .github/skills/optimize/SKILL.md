...
This compatibility wrapper exposes the `optimize` skill for the `.github/skills` layout while keeping `skills/optimize/SKILL.md` as the canonical source of truth.
