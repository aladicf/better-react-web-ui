...
This compatibility wrapper exposes the `localize` skill for the `.github/skills` layout while keeping `skills/localize/SKILL.md` as the canonical source of truth.
