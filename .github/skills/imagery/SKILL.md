...
This compatibility wrapper exposes the `imagery` skill for the `.github/skills` layout while keeping `skills/imagery/SKILL.md` as the canonical source of truth.
