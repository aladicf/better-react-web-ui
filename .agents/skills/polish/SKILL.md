...
This compatibility wrapper exposes the `polish` skill for the `.agents/skills` layout while keeping `skills/polish/SKILL.md` as the canonical source of truth.
