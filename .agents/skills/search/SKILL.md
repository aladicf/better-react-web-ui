...
This compatibility wrapper exposes the `search` skill for the `.agents/skills` layout while keeping `skills/search/SKILL.md` as the canonical source of truth.
