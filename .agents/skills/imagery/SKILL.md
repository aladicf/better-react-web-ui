...
This compatibility wrapper exposes the `imagery` skill for the `.agents/skills` layout while keeping `skills/imagery/SKILL.md` as the canonical source of truth.
