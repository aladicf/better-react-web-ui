...
This compatibility wrapper exposes the `animate` skill for the `.agents/skills` layout while keeping `skills/animate/SKILL.md` as the canonical source of truth.
