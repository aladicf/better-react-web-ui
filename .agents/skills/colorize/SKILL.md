...
This compatibility wrapper exposes the `colorize` skill for the `.agents/skills` layout while keeping `skills/colorize/SKILL.md` as the canonical source of truth.
