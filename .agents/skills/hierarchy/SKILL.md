...
This compatibility wrapper exposes the `hierarchy` skill for the `.agents/skills` layout while keeping `skills/hierarchy/SKILL.md` as the canonical source of truth.
