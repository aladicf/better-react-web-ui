...
This compatibility wrapper exposes the `security-ux` skill for the `.agents/skills` layout while keeping `skills/security-ux/SKILL.md` as the canonical source of truth.
