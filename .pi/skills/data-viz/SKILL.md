...
This compatibility wrapper exposes the `data-viz` skill for the `.pi/skills` layout while keeping `skills/data-viz/SKILL.md` as the canonical source of truth.
