...
Use this reference for surface treatments, depth systems, and typographic or motion-led modifiers that sit on top of a primary structural direction.

These are selective tools, not default shells. Start with a structural direction from [design directions](design-directions.md) first, then add at most one expressive modifier when the brand and content genuinely support it.
