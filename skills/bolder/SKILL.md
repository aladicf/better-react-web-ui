---
name: bolder
description: Increase visual impact, contrast, personality, and compositional confidence when a design feels bland, generic, or too safe. Use when the user wants stronger visual impact, more drama, more personality, or more confidence beyond color alone.
metadata:
...
Consult the [ai slop detection](../frontend-design/reference/ai-slop-detection.md) reference when checking whether "bolder" choices are actually just generic trend cargo-culting.
Consult the [finishing touches](../frontend-design/reference/finishing-touches.md) when stronger personality should come from accent borders, upgraded defaults, background decoration, or more distinctive component presentation.
