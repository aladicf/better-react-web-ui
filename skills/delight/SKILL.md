...
Delight is not a license for random whimsy. The quieter the product category, the more subtle the delight should be.

Consult the [ai slop detection](../frontend-design/reference/ai-slop-detection.md) reference so delight stays distinctive instead of sliding into generic trend decoration.
Consult the [finishing touches](../frontend-design/reference/finishing-touches.md) when delight should come from upgraded defaults, accent borders, subtle background treatments, or unexpected component presentation.
...
- Use delight to reinforce the chosen personality, not fight it
- Prefer low-complexity enhancements to the defaults before inventing entirely new UI patterns
- Empty states often deserve more visual flair than core task screens
...
- Upgrade existing bullets, links, checkboxes, headings, and cards before inventing brand new components
- Add small accent borders to create identity cheaply and cleanly
- Prefer spacing, subtle background shifts, or restrained shadows before adding lots of borders
- Keep decorative backgrounds low-contrast so content remains dominant
...
- Keep background decoration low-contrast; if it competes with content, it's no longer delight
...
- Treat delight as permission for random whimsy or off-brand decoration
- Add extra borders when spacing, accent color, or a subtle surface change would work better
