...
These archetypes are hypothetical inspection aids, not research participants. Their behavior descriptions suggest questions to test. They do not prove task times, conversion effects, or abandonment. Report observed interaction failures separately from inferred risks.

## 1. Impatient Power User — "Alex"

**Profile**: Experienced with similar products. Use this perspective to inspect repeated steps and access to efficient workflows.
...
- Check whether delays and repeated guidance obstruct frequent tasks
...
**Profile**: New to this type of product. Use this perspective to inspect discoverability, terminology, and recovery without assuming prior knowledge.
...
If the resolved application's context identifies its audience, derive additional hypothetical personas only when they expose a relevant gap in the predefined inspection perspectives:
