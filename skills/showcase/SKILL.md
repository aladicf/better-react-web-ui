...
Consult the [ai slop detection](../frontend-design/reference/ai-slop-detection.md) so “extraordinary” stays specific to the product instead of becoming expensive trend cargo culting.
