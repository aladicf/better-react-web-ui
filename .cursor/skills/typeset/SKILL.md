...
This compatibility wrapper exposes the `typeset` skill for the `.cursor/skills` layout while keeping `skills/typeset/SKILL.md` as the canonical source of truth.
