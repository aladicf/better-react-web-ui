...
This compatibility wrapper exposes the `add-ui` skill for the `.cursor/skills` layout while keeping `skills/add-ui/SKILL.md` as the canonical source of truth.
