...
This compatibility wrapper exposes the `frontend-design` skill for the `.cursor/skills` layout while keeping `skills/frontend-design/SKILL.md` as the canonical source of truth.
