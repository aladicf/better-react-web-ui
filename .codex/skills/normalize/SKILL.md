...
This compatibility wrapper exposes the `normalize` skill for the `.codex/skills` layout while keeping `skills/normalize/SKILL.md` as the canonical source of truth.
