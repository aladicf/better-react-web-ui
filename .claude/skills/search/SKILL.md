...
This compatibility wrapper exposes the `search` skill for the `.claude/skills` layout while keeping `skills/search/SKILL.md` as the canonical source of truth.
