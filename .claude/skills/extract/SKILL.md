...
This compatibility wrapper exposes the `extract` skill for the `.claude/skills` layout while keeping `skills/extract/SKILL.md` as the canonical source of truth.
