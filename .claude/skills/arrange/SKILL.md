...
This compatibility wrapper exposes the `arrange` skill for the `.claude/skills` layout while keeping `skills/arrange/SKILL.md` as the canonical source of truth.
